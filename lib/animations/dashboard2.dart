...
class _Dashboard2State extends State<Dashboard2> with TickerProviderStateMixin {
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      TextWidget(
                          "Ragupathi", 25, Colors.black54, FontWeight.bold),
                    ],
                  ),
            ...
            SlideTransition(position: _offsetAnimation2, child: categoryRow()),
            SizedBox(
              height: 8,
            ),
            AnimatedOpacity(
            ...
            Expanded(
                child: SlideTransition(
                    position: _offsetAnimation3, child: doctorList())),
          ],
        ),
      )),
    );
